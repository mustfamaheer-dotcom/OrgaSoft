...
const AdminDashboard: React.FC<AdminDashboardProps> = ({ onNavigate }) => {
  ...
  const confirmDelete = () => {
    ...
    else if (deleteTarget.type === 'orgaProService') setDataAndMarkDirty({ ...data, orgaProServices: { ...data.orgaProServices, items: data.orgaProServices.items.filter(s => s.id !== deleteTarget.id) } });
